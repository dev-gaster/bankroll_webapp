  ...
  <v-container class="my-12">
    <v-card class="mx-auto" max-width="800" flat>
      ...
      <ul>
        <li>
          <p>
            ...
            Company downloaded by You on any electronic device, named Bankroll
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            Gasobu Technologies Uganda Limited, Block 230, Plot 591, Namugongo Road
            Kireka, Kampala Metropolitan Area.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Bankroll, accessible from
            <a
              href="https://bankroll.cash"
              rel="external nofollow noopener"
              target="_blank"
              >https://bankroll.cash</a
            >
          </p>
        </li>
        <li>
      ...
      <p>
        ...
        or trade practice. Without limitation to the foregoing, the Company provides no
        warranty or undertaking, and makes no representation of any kind that the Service
        will meet Your requirements, achieve any intended results, be compatible or work
      ...
      <p>
        ...
        performance of an obligation under these Terms shall not affect a party's ability
      ...
      <p>
        ...
        to You on our Service. You agree that the original English text shall prevail in
      ...
      <ul>
        <li>
          ...
          <a
            href="https://bankroll.cash/contact"
            rel="external nofollow noopener"
            target="_blank"
            >https://bankroll.cash/contact</a
          >
        </li>
      </ul>
    </v-card>
