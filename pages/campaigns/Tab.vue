...
<template>
  <div class="tab-sticky">
    ...
    >
      ...
      <v-tab value="tab-1" class="custom-tab text-none">
        Details
      </v-tab>
  ...
  <v-tabs-window v-model="tab">
    <v-tabs-window-item value="tab-1">
      <v-card>
        <v-card-text>
          Sarah is a bright, kind-hearted 9-year-old with a love for storytelling, drawing, and helping others. She dreams of becoming a doctor one day so she can heal and care for people in need just like the doctors she now sees every week. In March this year, Sarah was diagnosed with acute lymphoblastic leukemia, a type of cancer that affects the blood and bone marrow. Since then, life has drastically changed for her and our family. What used to be simple daily routines have turned into long hospital stays, intense chemotherapy sessions, and many nights filled with uncertainty.
          Despite the pain and fatigue, Sarah has remained strong and hopeful always wearing her signature smile and bringing comfort to others around her, even in the hospital ward.
...
.custom-tabs {
  --v-tabs-height: 36px; /* Make overall tab container shorter */
  min-height: 36px !important;
  padding: 0 !important;
}

.custom-tab {
  min-height: 32px !important; /* Reduce height of each tab */
